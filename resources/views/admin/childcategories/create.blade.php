        ...
        <section class="s-space-bottom-full bg-accent-shadow-body">
            <div class="container">
                <div class="breadcrumbs-area">
                    <ul>
                        <li><a href="/">Home</a> -</li>
                        <li class="active">Create Child Category</li>
                    </ul>
                </div>
            </div>
            <div class="container">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-12 mb--sm">
                        <div class="gradient-wrapper">
                            ...
                            <div class="input-layout1 gradient-padding post-ad-page">
                                <form action="{{ route('admin.childcategories.store') }}"  method="POST" enctype="multipart/form-data" id="post-add-form">
                                    @csrf
                                    <div class="border-bottom-2 mb-50 pb-30">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 col-12">
                                                <label class="control-label" for="add-title">Child Category Name <span> *</span></label>
                                            </div>
