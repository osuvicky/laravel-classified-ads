        ...
        <section class="s-space-bottom-full bg-accent-shadow-body">
            <div class="container">
                <div class="breadcrumbs-area">
                    <ul>
                        <li><a href="/">Home</a> -</li>
                        <li class="active">View {{ $sub_category->name}}</li>
                    </ul>
                </div>
            </div>
            <div class="container">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <input type="text" id="add-title" class="form-control" name="name" value="{{ $sub_category->name}}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        @error('name')
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <div class="custom-select">
                                                        <select id="category-name" class='select2' name="category_id" disabled>
