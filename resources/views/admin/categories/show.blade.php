        ...
        <section class="s-space-bottom-full bg-accent-shadow-body">
            <div class="container">
                <div class="breadcrumbs-area">
                    <ul>
                        <li><a href="/">Home</a> -</li>
                        <li class="active">View {{ $category->name}}</li>
                    </ul>
                </div>
            </div>
            <div class="container">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <input type="text" id="add-title" class="form-control" name="name" value="{{ $category->name}}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        @error('name')
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <ul class="picture-upload">
                                                        <li><img src="{{ Storage::url($category->image) }}" style="object-fit:contain; width:50%; height:50%;"/></li>
                                                        <!-- <li>
                                                            <input type="file" id="img-upload1" class="form-control" name="image" value="{{ $category->image}}" readonly>
                                                        </li> -->
                                                    </ul>
                                                </div>
                                            </div>
