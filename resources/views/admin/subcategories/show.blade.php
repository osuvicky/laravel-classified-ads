        ...
        <section class="s-space-bottom-full bg-accent-shadow-body">
            <div class="container">
                <div class="breadcrumbs-area">
                    <ul>
                        <li><a href="/">Home</a> -</li>
                        <li class="active">View {{ $child_category->name}}</li>
                    </ul>
                </div>
            </div>
            <div class="container">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-12 mb--sm">
                        <div class="gradient-wrapper">
                            <div class="gradient-title">
                                <h2>View {{ $child_category->name}}</h2>
                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <input type="text" id="add-title" class="form-control" name="name" value="{{ $child_category->name}}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        @error('name')
                                                ...
                                                <div class="form-group">
                                                    <div class="custom-select">
                                                        <select id="category-name" class='select2' name="sub_category_id">
                                                            ...
                                                            <option value="{{ $subcategory->id }}" {{ $subcategory->id == $child_category->subcategory_id ? 'selected' : ''}}>{{ $subcategory->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
