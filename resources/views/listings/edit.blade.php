                                ...
                                <form action="{{ route('listings.update', $listing->id) }}"  method="POST" enctype="multipart/form-data" id="post-add-form">
                                    ...
                                    <div class="border-bottom-2 mb-50 pb-30">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <input type="text" id="add-title" class="form-control" placeholder="Ads Title" name="title" value="{{ $listing->title }}">
                                                </div>
                                            </div>
                                        </div>
                                        @error('title')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <input type="text" id="add-title" class="form-control" placeholder="Location" name="location" value="{{ $listing->location }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <textarea placeholder="What makes your ad unique" class="textarea form-control" name="description" id="description" rows="4" cols="20" data-error="Message field is required" >{{ $listing->description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        @error('description')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <input type="text" id="describe-ad2" class="form-control price-box" placeholder="$ Price" name="price" value="{{ $listing->price }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <input type="text" id="add-title" class="form-control" placeholder="Phone Number" name="phone_number" value="{{ $listing->phone_number }}">
                                                </div>
                                            </div>
                                        </div>
                                        @error('phone_number')
